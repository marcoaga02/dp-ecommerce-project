...
type ProductClientInterface interface {
	...
	CreateProduct(code, name string, size pb.Size, color, description string, stock uint32, price float64) (bool, error)
	...
	UpdateProduct(code, name string, size pb.Size, color, description string, stock uint32, price float64) (bool, error)
