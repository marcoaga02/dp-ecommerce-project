module github.com/marcoaga02/dp-ecommerce-project/ecommerce/orchestrator
...
require (
	...
	github.com/marcoaga02/dp-ecommerce-project/ecommerce/proto v0.0.0-20250803132158-fec6a7bce565
